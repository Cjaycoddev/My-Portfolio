  ...
  return (
    ...
    <div className="relative bg-gradient-to-br from-gray-950 via-purple-950 to-black text-gray-100 min-h-screen flex flex-col overflow-x-hidden scroll-smooth">
      ...
      {/* NAVBAR */}
            ...
            {/* 💻 NAVIGATION LINKS CONTAINER - CRITICAL CHANGES HERE */}
            <div 
              className={`${
                ...
                flex flex-col // **REPEATING FLEX HERE FOR PRIORITY**
                items-center 
                justify-center 
                space-y-8 
                text-2xl 
                ...
                // DESKTOP STYLES (md: prefix ensures these only apply on desktop)
                md:relative md:top-auto md:left-auto md:h-auto 
                md:flex-row md:space-x-8 md:space-y-0 
                md:bg-transparent md:text-lg
              `}
            >
              {["Home", "About", "Skills and qualifications","Tools and technologies", "Projects", "Contact"].map((item) => (
                <a
                  ...
                  // LINKS NOW GET DISPLAY:BLOCK ON MOBILE TO ENSURE FULL ROW TAKEOVER
                  className="relative group font-medium tracking-wide text-center py-2 px-4 
                    block // **CRUCIAL: Makes the link a block element on mobile**
                    md:inline-block // Reverts to inline-block on desktop
                    md:text-left"
                >
